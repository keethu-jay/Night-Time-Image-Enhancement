...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--checkpoints_dir", type=str, default="../checkpoints", help="models are saved here (top-level /checkpoints)")
        # model parameters
        ...
        # Used in this project during refinement to reduce visible artifacts (dropout disabled).
